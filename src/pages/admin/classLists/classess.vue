<template>
  <div class="wrapper">
    <el-breadcrumb style="margin-bottom:10px;cursor: pointer;">
      <el-breadcrumb-item :to="{ path: '/classLists' }" class="daohang" v-if="identity == '1' ||identity == '0'" style="cursor: pointer;">返回上一页</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/classLists' }" class="daohang" v-if="identity == '2'" style="cursor: pointer;">返回上一页</el-breadcrumb-item>
    </el-breadcrumb>
    <el-table
    :data="tableData"
    stripe
